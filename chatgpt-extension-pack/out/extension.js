...
function activate(context) {
    ...
    // view side bar 
    // using web view
    context.subscriptions.push(vscode.commands.registerCommand('chatgpt-extension-pack.openWebview', () => {
        ...
        if (panel) {
            ...
            panel = vscode.window.createWebviewPanel('chatGpt', // Identifies the type of the webview. Used internally
